...
$episode_run_time = doo_isset($postmeta, 'episode_run_time');
...
$rt = $runtime 
      ?: (is_array($episode_run_time) ? $episode_run_time[0] : $episode_run_time);
