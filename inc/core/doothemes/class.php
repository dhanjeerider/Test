...
class Doothemes {
	...
	function license_page(){
		...
		echo '<tr><td>';
		echo '<input value="d1f9c3f745c7e0dd1efb6cdb280a2f83" id="'.$idkey.'" name="'.$idkey.'" type="text" class="dt_text_license dt_'.$status.'" value="'. esc_attr($license).'" placeholder="'. __d('License'). '"/>';
		// WP_nonce
